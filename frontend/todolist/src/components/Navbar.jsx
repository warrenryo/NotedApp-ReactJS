...
function Navbar({ userInfo, onSearchNote }) {
  ...
  return (
    <header className="flex shadow-md flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-4 dark:bg-neutral-800">
      <nav
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <img src="images/react.png" className="w-10 mr-2" alt="" />
          <a
